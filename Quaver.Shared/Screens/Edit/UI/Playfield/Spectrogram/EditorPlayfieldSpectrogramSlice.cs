...
namespace Quaver.Shared.Screens.Edit.UI.Playfield.Spectrogram
{
    public class EditorPlayfieldSpectrogramSlice : Sprite
    {
        ...
        public EditorPlayfieldSpectrogramSlice(EditorPlayfield playfield, Color[] pixels, int textureWidth,
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            _sliceSprite.Tint = new Color(1f, 1f, 1f,
                ConfigManager.EditorSpectrogramBrightness.Value / 100f);
